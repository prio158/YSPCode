...
//     // 16/9 *  width / height  = 16/9 *  800 / 600 = 64/27
...
//                 // 如果不是最新的播放序列，则将其出队列，以尽快读取最新的播放序列的Frame
...
//          * is->audio_buf_index >= is->audio_buf_size 说明buf已经读满了
...
//             goto out;
//         SDL_PauseAudioDevice(audio_dev, 0); //0：代表开启，回调函数会触发
//         break;
//     case AVMEDIA_TYPE_VIDEO:
